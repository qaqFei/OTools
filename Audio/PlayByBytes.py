...
def PlayByByes(data:bytes):
    '''
    Play a wav file. \n
    File must from pydub.AudioSegment.export(path,'wav')
    '''
    hdr=data[0:44]
    ...
    del data,hdr,DirectSound,sdesc,buffer,event

def _test():
    PlayByByes(open("AudioTest.wav","rb").read())
